...
|---|---|---|
| 01 | รายได้รวมจากการเช่าภาพยนตร์มีแนวโน้มเปลี่ยนแปลงไปอย่างไร | ... | 
| 02 | แต่ละสาขามีแนวโน้มรายได้แตกต่างกันอย่างไร | ... | 
| 03 | รายได้ในแต่ละวันของสัปดาห์แตกต่างกันอย่างไร | ... | 

### กลุ่มที่ 2 — ลูกค้า (3 ข้อ)

| # | คำถาม | ตารางต้นทางที่เกี่ยวข้อง | 
|---|---|---|
| 04 | ลูกค้าในแต่ละภูมิภาคเช่าภาพยนตร์มากน้อยแค่ไหน | ... | 
| 05 | ลูกค้า 5 อันดับแรกที่ใช้จ่ายและเช่าภาพยนตร์บ่อยที่สุดคือใคร | ... | 
| 06 | แต่ละสาขาตั้งอยู่ห่างจากที่อยู่ลูกค้าเป็นระยะทางเท่าไหร่ | ... | 

### กลุ่มที่ 3 — กลุ่มลูกค้า & การเช่าซ้ำ (4 ข้อ)

| # | คำถาม | ตารางต้นทางที่เกี่ยวข้อง | 
|---|---|---|
| 07 | หากแบ่งลูกค้าออกเป็น 4 กลุ่มตามความถี่และยอดเงินที่จ่ายในการเช่า จะแบ่งได้อย่างไร | ... | 
| 08 | ลูกค้าแต่ละกลุ่มนิยมเช่าภาพยนตร์หมวดหมู่ใดมากที่สุด | ... | 
| 09 | โดยเฉลี่ยลูกค้าใช้เวลากี่สัปดาห์ก่อนจะกลับมาเช่าซ้ำ | ... | 
| 10 | เมื่อลูกค้ากลับมาเช่าซ้ำ มักจะเช่าหมวดหมู่เดิมหรือเปลี่ยนไปหมวดหมู่อื่น | ... | 

### กลุ่มที่ 4 — เนื้อหาภาพยนตร์ (3 ข้อ)

| # | คำถาม | ตารางต้นทางที่เกี่ยวข้อง | 
|---|---|---|
| 11 | ภาพยนตร์แต่ละหมวดหมู่ถูกเช่าไปกี่ครั้ง | ... | 
| 12 | ภาพยนตร์แต่ละเรตถูกเช่าไปกี่ครั้ง | ... | 
| 13 | นักแสดงคนไหนที่ภาพยนตร์ของเขาถูกเช่าบ่อยที่สุด | ... | 

### กลุ่มที่ 5 — ร้าน/พนักงาน (1 ข้อ)

| # | คำถาม | ตารางต้นทางที่เกี่ยวข้อง | 
|---|---|---|
| 14 | ในแต่ละวันมีลูกค้ามาคืนภาพยนตร์กี่ครั้ง | ... |
| 15 | พนักงานแต่ละคนปล่อยเช่าภาพยนตร์ไปกี่ครั้ง | ... | 
| 16 | พนักงานแต่ละคนปล่อยเช่าภาพยนตร์ในแต่ละหมวดหมู่ไปกี่ครั้ง | ... | 
---
